              ...
              <button
                ...
                className={`px-4 py-2 text-xs uppercase tracking-wider font-semibold rounded-full transition-all duration-300 ${
                  activeCategory === category
                    ? "bg-[#201D18] text-[#F7F3EC] shadow-sm cursor-default"
                    : "text-[#78716C] hover:text-[#201D18] hover:bg-[#EFE7D8]/50"
                }`}
          ...
          {selectedItem && (
            ...
            >
              ...
              <motion.div
                ...
                className="max-w-4xl w-full bg-[#F7F3EC] rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row border border-[#D8CBB8]/20"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Left: Image */}
                <div className="md:w-3/5 bg-[#EFE7D8] relative aspect-square md:aspect-auto md:min-h-[500px]">
                  <Image
