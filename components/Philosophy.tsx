...
function AnimatedCounter({
  ...
  return (
    <span className="font-serif text-4xl md:text-5xl text-[#201D18] font-normal">
...
export default function Philosophy() {
  ...
  return (
    <section
      id="about"
      ref={containerRef}
      className="py-24 md:py-32 bg-[#F7F3EC] border-t border-[#D8CBB8]/20 overflow-hidden"
    >
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden aspect-[4/5] bg-[#EFE7D8] shadow-md">
              <video
                autoPlay
                loop
                muted
              ...
              >
                <source
                  src="/images/videos/rug-texture-loop-optimized.mp4"
                  type="video/mp4"
                />
              </video>
              {/* Soft tint blend */}
          ...
          >
            ...
            <h2 className="font-serif text-4xl sm:text-5xl text-[#201D18] font-normal mb-8 leading-tight">
              A Labor of Love
            </h2>
