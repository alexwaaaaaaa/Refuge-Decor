...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#F5EFE9] border-t border-[#D8CBB8]/30 py-20">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-start mb-16">
          {/* Brand Col */}
          <div className="md:col-span-4 text-left">
            <a href="#" className="font-serif text-2xl tracking-[0.25em] text-[#1C1C1C] font-bold">
              REFUGE
            </a>
          ...
          <div className="md:col-span-3 text-left">
            <h4 className="font-sans font-bold text-xs uppercase tracking-wider text-[#6B7051] mb-6">
              Studio Navigation
            </h4>
          ...
          <div className="md:col-span-5 text-left">
            ...
            {subscribed && (
              <p className="text-xs text-[#6B7051] mt-3 font-sans font-medium">
