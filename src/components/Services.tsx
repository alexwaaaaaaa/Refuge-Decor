        ...
        >
          ...
          >
            ...
            <div className="flex-1 flex flex-col text-left">
              <div className="flex items-center gap-3 text-[#6B7051] mb-4">
                <div className="p-2 rounded-lg bg-[#6B7051]/10">
              ...
              <h3 className="font-serif text-xl text-[#1C1C1C] font-normal mb-3">
                Real Estate Staging
              </h3>
