  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.5, -2]} receiveShadow castShadow>
        ...
        <meshStandardMaterial color="#FAF5F2" roughness={0.9} />
      </mesh>
      ...
      <mesh position={[0, -0.89, 0.3]} rotation={[-Math.PI / 2, 0, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#F5EFE9" roughness={0.95} />
      </mesh>
      ...
      <group position={[0, -0.4, 0.2]}>
        ...
        <mesh position={[-0.55, -0.22, 0.05]} castShadow receiveShadow>
          ...
          <meshStandardMaterial color="#FAF5F2" roughness={0.85} />
        </mesh>
        <mesh position={[0.55, -0.22, 0.05]} castShadow receiveShadow>
          <boxGeometry args={[1.05, 0.22, 0.8]} />
          <meshStandardMaterial color="#FAF5F2" roughness={0.85} />
        ...
        <mesh position={[-0.8, -0.05, 0.2]} rotation={[0, Math.PI / 8, Math.PI / 12]} castShadow>
          ...
          <meshStandardMaterial color="#6B7051" roughness={0.9} />
        </mesh>
      </group>
  ...
  return (
    <div className="w-full h-full relative">
      <Canvas
        ...
        onCreated={onCreated}
      >
        <color attach="background" args={["#FAF5F2"]} />

        {/* Ambient lighting */}
        <ambientLight intensity={0.55} color="#FAF5F2" />
